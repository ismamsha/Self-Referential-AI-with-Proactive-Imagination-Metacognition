...
\paragraph{Interactive demo.} \emph{Amoeba Mind}, a browser game in \path{game/} of the MSRA repository, playable at
\url{https://ismamsha.github.io/Self-Referential-AI-with-Proactive-Imagination-Metacognition/game/}, shows a single cell that imagines each bite before taking it, imprints a new slot for each novel
pattern, and tracks doubt and per-slot doubt with caution mode and repair. It is an illustration built on the
mechanisms of Parts~I and III, not a port of the benchmark code, and none of the paper's numbers come from it.
